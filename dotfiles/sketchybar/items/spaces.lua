...
-- C=Claude, W=WezTerm, S=Safari, M=Superhuman, N=Slack, G=Google Chat, O=Obsidian, T=TickTick, I=Notion Calendar
local workspace_names = { "C", "W", "S", "M", "N", "G", "O", "T", "I", "1", "2", "3", "4", "5" }
