...
-- C=Claude, W=WezTerm, S=Safari, M=Superhuman, N=Slack, G=Google Chat, O=Obsidian, T=TickTick, I=Notion Calendar, Y=Kaset/YouTube Music
local workspace_names = { "C", "W", "S", "M", "N", "G", "O", "T", "I", "Y", "1", "2", "3", "4", "5" }
