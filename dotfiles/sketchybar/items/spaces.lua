...
-- C=Claude, W=WezTerm, S=Safari, M=Superhuman, N=Slack, G=Google Chat, L=Linear, O=Obsidian, T=TickTick, I=Notion Calendar, Y=Kaset/YouTube Music, X=Google Chrome
local workspace_names = { "C", "W", "S", "M", "N", "G", "L", "O", "T", "I", "Y", "X", "1", "2", "3", "4", "5" }
